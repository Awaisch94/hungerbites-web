            ...
            <TabPanel value={value} index={1}>
              <Grid container spacing={3}>
                ...
                <Typography className={styles.info}>
                  For reliable on screen review of your order status, in
                  real-time, your data may be saved on this device by using
                  cookies. Please read our Cookie Policy and change your
                ...
                <Grid item xs={12} sm={12} md={6} lg={6}>
                  <Box className={styles.detail}>
                    ...
                    <Typography className={styles.icondetails}>
                      {" "}
                      <b>Delivery fees</b>{" "}
                    </Typography>
                  </Box>
                  <br />
                  <Typography className={styles.infodetail}>
                    Fee Rs 250.00{" "}
                  </Typography>
                  <br />
                  <br />
                  ...
                  <br />
                  <Typography className={styles.infodetail}>
                    12C/1 , MM Alam Road Gulberg 3, Lahore 54000
                  </Typography>
                </Grid>
                ...
                <Grid item xs={12} sm={12} md={6} lg={6}>
                  ...
                  <Typography className={styles.infodetail}>
                    {" "}
                    Monday - Friday 12:30 to 01:00AM{" "}
                  </Typography>
                  <Typography className={styles.infodetail}>
                    Saturday-Sunday 12:30 to 02:00PM{" "}
                  </Typography>
                  <br />
                  <Box className={styles.detail}>
                    <Typography>
                ...
                <Grid container>
                  <Grid item xs={12} sm={12} md={6} lg={6}>
                    <Box className={styles.contact}>
                      <Typography className={styles.contacts}>
                        {" "}
                        <b>Contact</b>{" "}
                      </Typography>{" "}
                      <br />
                      <center>
                        <form className={styles.form}>
                          ...
                          <Typography className={styles.terms}>
                            You agree to be remembered on this device and to
                            receive money-off coupons & exclusive offers.{" "}
                          </Typography>
                          <button className={styles.btn}>Save</button>
                        </form>
                      </center>
                      <Box className={styles.order}>
                        <Typography className={styles.ordering}>
                          <b>Ordering Method</b>
                        </Typography>
                        <input type="checkbox" name="" id="" />{" "}
                        <span className={styles.check}>PickUp</span> <br />
                        <input type="checkbox" name="" id="" />{" "}
                        <span className={styles.check}>Delivery</span> <br />
                        <center>
                          <input
                            type="name"
                            class="adress"
